        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('projects.teams.storeMember', ['project' => $project]) }}">
                        @csrf
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('projects.teams.index', $project) }}" class="text-sm text-gray-600 hover:text-gray-900 mr-4">
                                {{ __('Cancel') }}
                            </a>
